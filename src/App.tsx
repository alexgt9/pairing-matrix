...
const App = () => {
  return (
    <div className="flex">
      <aside id="sidebar" className="pr-4 bg-green-100 border-solid border-2 border-r-green-300">
        <nav>
          <ul>
            <li>
            ...
            <li>
              <a href={`about`} className="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6">
                <span className="inline-flex justify-center items-center ml-4">
